...
transgender_rights_overall_map<-tm_shape(trips_2021_spatial)+
          ...
          labels=c("Minimal Protections (TRIP<=3)", "Moderate Protections (3<TRIP<=8)", "Robust Protections (TRIP>8)"),
                                    ...
                                    tm_layout(frame=FALSE,
                                            ...
                                            attr.outside = TRUE,
                                              inner.margins=c(0.06, 0.1, 0.1, 0.08))+
          tm_credits("Map Author: Aditya Ranganath\nData Source: Myles Williamson/TRIP", position=c(0.02,0.01), size=0.38)
